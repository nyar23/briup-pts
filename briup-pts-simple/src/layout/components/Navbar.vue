<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper">
          <img :src="avatar || baseAvatar" class="user-avatar animate__animated animate__fadeIn">
    ...
    <iframe style="height: 30px; margin-top: 10px; float: right" frameborder="0" scrolling="no" hspace="0" src="http://i.tianqi.com/index.php?c=code&a=getcode&id=34&h=25&w=280" />
