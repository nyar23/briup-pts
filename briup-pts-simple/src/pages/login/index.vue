 ...
 * @LastEditors: Ronda
 * @LastEditTime: 2023-12-20 15:06:20
-->
<template>
      ...
      <div class="form">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left" size="small">
          ...
          <el-form-item prop="username">
            <el-input ref="username" v-model="loginForm.username" placeholder="请输入用户名" type="text">
          ...
          <div style="height: 20px" />
          <el-button type="success" :loading="loading" style="width: 100%" @click.native.prevent="handleLogin">登录
          </el-button>
        </el-form>
        <!-- 表单 -->
      </div>
