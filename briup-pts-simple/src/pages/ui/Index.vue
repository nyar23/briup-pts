<template>
    <div>
        ...
        <el-drawer title="添加检疫登记信息" :visible.sync="drawer" :direction="rtl" :before-close="handleClose">
            {{ ruleForm }}
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="批次编号" prop="grBatchId">
                    <el-select v-model="ruleForm.grBatchId" placeholder="请选择批次编号">
                        <el-option v-for="item in batchData" :key="bSerialId" :label="item.bDesc"
                ...
                <el-form-item label="检疫时间" prop="grTime">
                    <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="选择日期"
                        v-model="ruleForm.grTime" style="width: 100%;"></el-date-picker>
                </el-form-item>
                <el-form-item>
