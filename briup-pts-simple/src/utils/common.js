 ...
 * @LastEditors: Ronda
 * @LastEditTime: 2023-12-18 16:45:40
 */
...
export const authsPerms = {
    ...
    animal: {
        saveOrUpdate:
            "animal_saveOrUpdate;batch_queryAll;hurdles_selectAllHurdles",
    ...
    slaughteringGroup: {
        ...
        setAccount:
            "slaughteringGroup_updateAccount;slaughteringGroup_selectAllAccount"
    },
    // 冷库管理
    freezer: {
        saveOrUpdate:
            "freezer_saveOrUpdate;base_role_findAll;user_selectByRoleId",
    ...
    customer: {
        saveOrUpdate:
            "user_selectByRoleId;base_role_findAll;customer_saveOrUpdate",
    ...
    indexRecord: {
        saveOrUpdate:
            "indexRecord_saveOrUpdate;base_role_findAll;user_selectByRoleId",
    ...
    shiftCircle: {
        saveOrUpdate:
            "user_selectByRoleId;base_role_findAll;shiftCircle_saveOrUpdate;animal_findByAnimalId",
    ...
    inoculationRecord: {
        saveOrUpdate:
            "vaccines_queryAll;base_role_findAll;user_selectByRoleId;inoculationRecord_saveOrUpdate",
    ...
    feedRecord: {
        saveOrUpdate:
            "batch_queryAll;feed_queryAll;base_role_findAll;user_selectByRoleId;feedRecord_saveOrUpdate",
    ...
    situationReporting: {
        saveOrUpdate:
            "situationReporting_saveOrUpdate;base_role_findAll;user_selectByRoleId",
        delete: "situationReporting_deleteById",
        deleteAll: "situationReporting_deleteByIdAll",
        // 处理
        solve:
            "situationReporting_updateStatus;base_role_findAll;user_selectByRoleId"
    },
    // 病症记录
    diseaseRecord: {
        saveOrUpdate:
            "diseaseRecord_queryAllDisease;base_role_findAll;user_selectByRoleId;diseaseRecord_saveOrUpdate",
    ...
    quarantineRegistration: {
        saveOrUpdate:
            "batch_queryAll;base_role_findAll;user_selectByRoleId;quarantineRegistration_saveOrUpdate;file_upload",
    ...
    issueRecord: {
        saveOrUpdate:
            "base_role_findAll;user_selectByRoleId;customer_queryAll;issueRecord_saveOrUpdate",
    ...
    role: {
        saveOrUpdate:
            "base_authority_findAllAuthorityTree;base_role_saveOrUpdateRole",
        delete: "base_role_deleteRoleById"
    },
    // 权限管理
    auth: {
        saveOrUpdate:
            "base_authority_saveOrUpdate;base_authority_findAllAuthorityTree",
    ...
    api: {
        toMount:
            "base_backendapi_findByCondition;base_authority_authorityWithBackendApi"
    }
};
